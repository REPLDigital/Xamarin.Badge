...
namespace Badge.Plugin
{
    ...
    /// </summary>
    public static class CrossBadge
    {
        private static Lazy<IBadge> Implementation = new Lazy<IBadge>(CreateBadge, System.Threading.LazyThreadSafetyMode.PublicationOnly);
